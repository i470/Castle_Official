...
This mechanism has been integrated into Bitcore-Node-Castle which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/castle/insight-api-castle#web-socket-api](https://github.com/castle/insight-api-castle#web-socket-api) 
* API: [https://github.com/castle/insight-api-castle#swifttx-transactions](https://github.com/castle/insight-api-castle#swifttx-transactions) 
...
By default, the Castle Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Castle Core daemon:
