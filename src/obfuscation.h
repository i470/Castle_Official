...
{
public:
    /// Is the inputs associated with this public key? (and there is 40000 CSTL - checking if valid masternode)
...
public:
    ...
    /// Get the denominations for a specific amount of castle.
