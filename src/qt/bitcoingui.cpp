                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Castle Core 2018") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Castle address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and castle: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zCSTL"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Castle Core"), this);
    aboutAction->setStatusTip(tr("Show information about Castle Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Castle"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Castle addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Castle addresses"));
    ...
    openAction->setStatusTip(tr("Open a Castle: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Castle Core help message to get a list with possible Castle command-line options"));
...
void BitcoinGUI::setNumBlocks(int count)
{
    ...
    if (masternodeSync.IsBlockchainSynced()) {
        ...
        if (masternodeSync.IsSynced()) {
            ...
            progressBar->setFormat(tr("Block Sync Complete. Updating masternodes: %p%"));
