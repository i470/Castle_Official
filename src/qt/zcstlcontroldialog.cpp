...
#include "ui_zcstlcontroldialog.h"
...
std::list<std::string> ZCstlControlDialog::listSelectedMints;
std::list<CZerocoinMint> ZCstlControlDialog::listMints;
...
void ZCstlControlDialog::updateLabels()
{
    ...
    privacyDialog->setZCstlControlLabels(nAmount, listSelectedMints.size());
}

std::vector<CZerocoinMint> ZCstlControlDialog::GetSelectedMints()
{
