 ...
 */
    ...
    typeWidget->addItem(tr("Received CSTL from zCSTL"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zCSTL"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zCstl));
