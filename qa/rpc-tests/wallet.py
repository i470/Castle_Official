...
#   c) node1 mines 32 blocks, so now node 0 has 60001cstl, node 1 has 4250cstl, node2 has none.
#   d) node0 sends 601 cstl to node2, in two transactions (301 cstl, then 300 cstl).
