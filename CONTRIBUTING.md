Contributing to Castle Core
============================

The Castle Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Castle Core project, and is not to be
confused with overall Castle Network Protocol consensus changes.

Whether a pull request is merged into Castle Core rests with the project merge
...
Patches that change Castle consensus rules are considerably more involved than
...
Where a patch set proposes to change the Castle consensus, it must have been
...
The project leader is the release manager for each Castle Core release.
